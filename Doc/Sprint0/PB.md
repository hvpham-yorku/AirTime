1.	Any user should be able to create an account with a valid password. The system will display an error message and prompt the user to try again if the password is not valid.
